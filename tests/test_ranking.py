...
def test_rank_channels_orders_by_total_views_then_average():
    channels = [
        ChannelSnapshot("b", "Beta", "Hindi", 1000, 10, 100, None, None),
        ChannelSnapshot("a", "Alpha", "Hindi", 2000, 10, 200, None, None),
        ChannelSnapshot("c", "Gamma", "Hindi", 1000, 10, 150, None, None),
    ]
