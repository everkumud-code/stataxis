...
def test_admin_can_add_remove_and_evaluate() -> None:
...
def test_premium_roles_can_evaluate_but_not_manage_catalog(role: UserRole) -> None:
...
def test_free_role_requires_premium_for_evaluation() -> None:
